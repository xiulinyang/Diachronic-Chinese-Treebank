...
def storeText(data, filename):
    with open(filename, "w") as file_work:
        for para in data:
...
# cleaning the final version of the corpus: get rid of unnecessary space
treebank_1950 = open('corpus_50_65.txt', 'r', encoding='utf-8').read()
treebank_1950 = treebank_1950.replace(' ', '')
print(treebank_1950)
with open('corpus_50_65.txt', 'w', encoding='utf-8') as file_50:
    file_50.write(treebank_1950)

treebank_1966 = open('corpus_66_76.txt', 'r', encoding='utf-8').read()
treebank_1966 = treebank_1966.replace(' ', '')
print(treebank_1966)
with open('corpus_66_76.txt', 'w', encoding='utf-8') as file_66:
    file_66.write(treebank_1966)

treebank_1978 = open('corpus_78_99.txt', 'r', encoding='utf-8').read()
treebank_1978 = treebank_1978.replace(' ', '')
print(treebank_1978)
with open('corpus_78_99.txt', 'w', encoding='utf-8') as file_78:
    file_78.write(treebank_1978)

treebank_2000 = open('corpus_00_10.txt', 'r', encoding='utf-8').read()
treebank_2000 = treebank_2000.replace(' ', '')
print(treebank_2000)
with open('corpus_00_10.txt', 'w', encoding='utf-8') as file_00:
    file_00.write(treebank_2000)
...
print('There are ' + str(len(treebank_1950)) + ' characters in corpus 1950-1965 (including punctuation characters).')
print('There are ' + str(len(re.findall(r'\w', treebank_1950))) + ' characters in corpus 1950-1965 (without punctuation characters).')


print('There are ' + str(len(treebank_1966)) + ' characters in corpus 1966-1976 (including punctuation characters).')
print('There are ' + str(len(re.findall(r'\w', treebank_1966))) + ' characters in corpus 1966-1976 (without punctuation characters).')

print('There are ' + str(len(treebank_1978)) + ' characters in corpus 1978-1999 (including punctuation characters).')
print('There are ' + str(len(re.findall(r'\w', treebank_1978))) + ' characters in corpus 1978-1999 (without punctuation characters).')

print('There are ' + str(len(treebank_2000)) + ' characters in corpus 2000-2010 (including punctuation characters).')
print('There are ' + str(len(re.findall(r'\w', treebank_2000))) + ' characters in corpus 2000-2010 (without punctuation characters).')

print('There are ' + str(len(treebank_1950) + len(treebank_1966) + len(treebank_1978) + len(treebank_2000)) +
      ' characters in corpus (including punctuation characters)')

print('There are ' + str(len(re.findall(r'\w', treebank_1950)) + len(re.findall(r'\w', treebank_1966)) + len(re.findall(r'\w', treebank_1978)) + len(re.findall(r'\w', treebank_2000))) +
